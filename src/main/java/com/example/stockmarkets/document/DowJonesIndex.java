...
public class DowJonesIndex {
    ...
    private Date date;    //the last business day of the work (this is typically a Friday)
    ...
    private Double percentChangeVolumeOverLastWeek;    //the percentage change in the number of shares of stock that traded hands for this week compared to the previous week
    ...
    private Double percentChangeNextWeeksPrice;    //the percentage change in price of the stock in the following week days_to_next_dividend;    //the number of days until the next dividend
